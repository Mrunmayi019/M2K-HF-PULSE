...
Sample: 10 synthetic patients (6 per scenario type, known ground truth), replayed through the live, fixed API at 2-worker concurrency.
Completed: 27/30

Live severity MAE (post-fix): 0.0247  [95% bootstrap CI 0.0171, 0.0336]
